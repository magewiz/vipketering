    ...
    <section class="py-20 md:py-28 bg-paper">
      <div class="maxw px-5 md:px-10 grid lg:grid-cols-12 gap-12 items-center">
        <div class="lg:col-span-5">
          <img :src="c.intro.image" alt="VIP Catering — Најдобриот кетеринг во градот" class="w-full rounded-sm shadow-[0_30px_60px_-30px_rgba(0,0,0,.85)] reveal">
        </div>
    ...
    <section class="py-24 md:py-32 bg-paper">
      <div class="maxw px-5 md:px-10 grid lg:grid-cols-2 gap-16 items-center">
        <div class="grid grid-cols-2 gap-4 reveal">
          <img v-if="c.why.images[0]" :src="c.why.images[0]" alt="" class="w-full aspect-[3/4] object-cover">
          <img v-if="c.why.images[1]" :src="c.why.images[1]" alt="" class="w-full aspect-[3/4] object-cover translate-y-8">
          <img v-if="c.why.images[2]" :src="c.why.images[2]" alt="" class="w-full aspect-[16/10] object-cover col-span-2">
        </div>
        <div>
